...
El comando \`/authorize\` conecta servicios de terceros (como Google, GitHub o Microsoft) a tu agente de xAI Workspace. Una vez conectado, tu agente puede interactuar con estos servicios en tu nombre.
