...
Il comando \`/authorize\` collega servizi di terze parti (come Google, GitHub o Microsoft) al tuo agente xAI Workspace. Una volta collegati, il tuo agente può interagire con questi servizi per tuo conto.
